...
function getItem() {
    return __awaiter(this, void 0, void 0, function () {
        var item, id, cart, img, item_title, item_meta, ratingDiv, i, rate, rate, count, stock, price, desc, countHolder, add, sub, buynow;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getSingleProduct(parseInt(window.localStorage.getItem("current_item")))];
                case 1:
                    item = _a.sent();
                    id = item.id;
                    ...
                    item_meta = document.getElementById("item-meta");
                    ratingDiv = document.createElement("p");
...
function populateLandingCarousel() {
    return __awaiter(this, void 0, void 0, function () {
        var products, landingCarousel;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getInCategory(window.localStorage.getItem("current_cat"))];
                case 1:
                    products = _a.sent();
                    landingCarousel = document.getElementById("flow");
